import NavLinkPto from "./navLink";

export const MAIN_NAV: NavLinkPto[] = [
  {
    identifier: "products",
    href: "products"
  },
...
export const PRODUCT_FOOTER_NAV: NavLinkPto[] = [
  {
    identifier: "paymentsMethods",
