...
export default function View({
  ...
  return (
    <div
      className={`${hidden ? "hidden " : "flex "} relative isolate items-center gap-x-6 overflow-hidden bg-amber-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1`}
    >
      <div
      ...
      >
        <div
          className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-[#f59e0b] to-[#f59e0b] opacity-30"
          style={{
            clipPath:
